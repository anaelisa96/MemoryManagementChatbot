...
public:
    ...
    /* 
    My Comment - Task 1 : GetChatLogicHandle() function returns a raw pointer of type
                          ChatLogic. Since _chatlogic is now a unique smart pointer
                          we must use the .get() function to convert it in raw pointer.
    */
    // getter / setter
